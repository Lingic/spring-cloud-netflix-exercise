...
public class Connector {
	...
	private static final String PATH = "C:/Likui/github/wifi/";
//	private static final String PATH = "C:\\Likui\\github\\wifi-connector-master\\connector\\src\\main\\resources\\";
    /**
     * 密码路径
     */
//    public static final String PASSWORD_PATH = "D:\\wlan\\password\\wake.txt";
    public static final String PASSWORD_PATH = PATH + "wake.txt";

    /**
     * 配置文件暂时存放路径
     */
//    public static final String PROFILE_TEMP_PATH = "D:\\wlan\\profile";
    public static final String PROFILE_TEMP_PATH = PATH + "profile";

    /**
     * 破解成功wifi存放路径
     */
//    public static final String RESULT_PATH = "D:\\wlan\\record.txt";
    public static final String RESULT_PATH = PATH + "record.txt";

    /**
     * 日志存放路径
     */
//    public static final String LOG_PATH = "D:\\wlan\\log.txt";
    public static final String LOG_PATH = PATH + "log.txt";
...
//        ssidList.add("ChinaNet-WWS2");
        ...
        ssidList.add("liuzhe");
//        ssidList.add("Xiaomi_FB52");
//        ssidList.add("E79C9FE5A5BDE38082");
//        ssidList.add("Tenda_332678");
//        ssidList.add("@PHICOMM_2B");
//        ssidList.add("A1033");
